 ...
 * Description: A small program that is a mixture of IO and cpu
 * basically just a gross mushing of the provided files for calculating
 * pi and r/w
 */
...
int main(int argc, char* argv[]){
	...
	//with default values, rw loop should happen 100 times, so lets just
	// ish it with the cpu bound stuff.
